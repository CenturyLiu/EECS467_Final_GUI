...
from PyQt5.QtGui import QImage, QIcon, QPixmap, QMovie
...
class ExampleContent(DemoItem):
    ...
    def createContent(self):
        ...
        self.screenshot = ImageItem(QPixmap(self._menu_manager.getImagePath(self.name)), 550, imgHeight, self)
        # self.screenshot = ImageItem(QPixmap("images/pepper_dance.gif"), 550, imgHeight, self, scale=1.0)
        ...
        # self.movie = QMovie("images/pepper_dance.gif")
